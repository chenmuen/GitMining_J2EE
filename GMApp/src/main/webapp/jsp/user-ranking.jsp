...
<c:import url="./_head.jsp" var="head">
	<c:param name="title" value="User Ranking | Languist"/>
</c:import>
${head}
...
<div class="app">
	...
	<c:import url="./_sidebar.jsp" var="sidebar">
		<c:param name="activeItem" value="User-Ranking"/>
	</c:import>
	${sidebar}
	...
	<div class="main">
		...
		<div class="header">
			<h1 id="put_title">Ranking of ${currentFilter} Users</h1>
...
<script src="assets/js/user-ranking.js"></script>
